...
<%DAO dao=new DAO();
ArrayList<PassengerBean>list=dao.myBooking(username);
 %>
 <div class="column">
    <div class="card">
 <%for(PassengerBean bean:list)
	 {%>
	 <h3><%= bean.getUsername()%></h3>
      <table cellpadding="40px" width="60%">
      <tr>
     <td> <h5>Flight:<%=dao.getFlightName(bean.getFlight_id()) %></h5></td>
     ...
     <input type="submit" value="Cancel Ticket" class="button button1">
     </form>
     </tr>
     <tr>
